...
def create_app():
    ...
    def check_auth():
        ...
        if local_preview or app.config.get("TESTING") or app.testing or "unittest" in sys.modules or request.path.startswith("/static") or request.path == "/api/health" or request.path.startswith("/strategy-lab"):
            return None
